...
def main():
    ...
    name = f"{model_name}"+"Unet"+source_dataset_name.replace("_IMAGE", "")+f"_{label_size}"
    ...
    model = UNet_carbon(**model_args).to(device)
    if args.pretrain:
